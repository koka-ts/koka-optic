    ...
    var proxy = new Proxy({}, {
        get: function (_target, prop) {
            ...
            if (!Number.isNaN(index)) {
                return createOpticProxy(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(path), false), [index], false));
            }
            return createOpticProxy(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(path), false), [prop], false));
        },
    });
...
var Optic = /** @class */ (function () {
        ...
        return new Optic({
            ...
            set: function (updater) {
                return function (root) {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [5 /*yield**/, tslib_1.__values(updater(root))];
                            case 1:
                                newRoot = _a.sent();
                                ...
                                return tslib_1.__generator(this, function (_e) {
                                    switch (_e.label) {
                                        case 0:
                                            ...
                                            return [5 /*yield**/, tslib_1.__values(optics[key].set(function () {
                                                    return tslib_1.__generator(this, function (_a) {
    ...
    Optic.optional = function (optic) {
        return Optic.root().select({
            get: function (root) {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [5 /*yield**/, tslib_1.__values(koka_1.Eff.result(optic.get(root)))];
                        case 1:
                            result = _a.sent();
                            if (result.type === 'ok') {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            newState = state;
                            return [5 /*yield**/, tslib_1.__values(optic.set(function () {
                                    return tslib_1.__generator(this, function (_a) {
            ...
            return optic.set(function (state) {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1: return [2 /*return*/, _a.sent()];
                        case 2: return [2 /*return*/, newState];
                    }
                });
            })(root);
        }
    ...
    Optic.prototype.select = function (selector) {
        var _a = this, get = _a.get, set = _a.set;
        var optic = new Optic({
            get: function (root) {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                isObjectState = typeof state === 'object' && state !== null;
                                opticMap = isObjectState ? opticWeakMap.get(state) : null;
                                if (!(opticMap === null || opticMap === void 0 ? void 0 : opticMap.has(optic))) return [3 /*break*/, 1];
                                target = opticMap.get(optic);
                                return [3 /*break*/, 3];
                            case 1: return [5 /*yield**/, tslib_1.__values(getOpticValue(selector.get(state)))];
                            case 2:
                                target = _a.sent();
                                if (isObjectState) {
                                    setOpticCache(state, optic, target);
                                ...
                                _a.label = 3;
                            case 3: return [5 /*yield**/, tslib_1.__values(updater(target))];
                            case 4:
                                newTarget = _a.sent();
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [5 /*yield**/, tslib_1.__values(koka_1.Eff.err('OpticErr').throw("[koka-optic] Index ".concat(index, " is not applied for an array")))];
                        case 1: throw _a.sent();
                        case 2:
                            if (!(index < 0 || index >= state.length)) return [3 /*break*/, 4];
                            return [5 /*yield**/, tslib_1.__values(koka_1.Eff.err('OpticErr').throw("[koka-optic] Index ".concat(index, " is out of bounds: ").concat(state.length)))];
                        case 3: throw _a.sent();
                        case 4: return [2 /*return*/, state[index]];
                    }
                });
            },
            set: function (newValue, state) {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [5 /*yield**/, tslib_1.__values(koka_1.Eff.err('OpticErr').throw("[koka-optic] Find ".concat(predicate, " is not applied for an array")))];
                        case 1: throw _a.sent();
                        case 2:
                            index = list.findIndex(predicate);
                            if (!(index === -1)) return [3 /*break*/, 4];
                            return [5 /*yield**/, tslib_1.__values(koka_1.Eff.err('OpticErr').throw("[koka-optic] Item not found"))];
                        case 3: throw _a.sent();
                        case 4:
                            target = list[index];
                            return [2 /*return*/, {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [5 /*yield**/, tslib_1.__values(koka_1.Eff.err('OpticErr').throw("[koka-optic] State does not match by ".concat(predicate)))];
                        case 1: throw _a.sent();
                ...
                return tslib_1.__generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 7:
                            ...
                            return [7 /*endfinally*/];
                        case 8: return [2 /*return*/, targetList];
                    }
                });
            },
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [5 /*yield**/, tslib_1.__values(koka_1.Eff.err('OpticErr').throw("[koka-optic] List length mismatch: ".concat(list.length, " !== ").concat(targetList.length)))];
                        case 1: throw _a.sent();
                        case 2:
                            _loop_2 = function (i) {
                        ...
                        case 5:
                            i++;
                            return [3 /*break*/, 3];
                        case 6: return [2 /*return*/, newList];
                    }
                });
            },
        });
    ...
    Optic.prototype.filter = function (predicate) {
        ...
        return this.select({
            get: function (list) {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!!Array.isArray(list)) return [3 /*break*/, 2];
                            return [5 /*yield**/, tslib_1.__values(koka_1.Eff.err('OpticErr').throw("[koka-optic] Filter ".concat(predicate, " is not applied for an array")))];
                        case 1: throw _a.sent();
                        case 2:
            ...
            set: function (filteredInfo, list) {
                var newList, filtered, indexRecord, indexList, filtered_1, filtered_1_1, newItem, key, index, i, index, newItem;
                var e_2, _a;
                return tslib_1.__generator(this, function (_b) {
                    newList = tslib_1.__spreadArray([], tslib_1.__read(list), false);
                    filtered = filteredInfo.filtered, indexRecord = filteredInfo.indexRecord, indexList = filteredInfo.indexList;
                    if (indexRecord) {
                        try {
                            for (filtered_1 = tslib_1.__values(filtered), filtered_1_1 = filtered_1.next(); !filtered_1_1.done; filtered_1_1 = filtered_1.next()) {
