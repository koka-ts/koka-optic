...
} : State extends number | string | boolean ? LeafOpticProxy<State> : never;
...
export declare class Optic<State, Root> {
    ...
    static object<T extends Record<string, AnyOptic>>(optics: T): Optic<{
    ...
    static set<State, Root>(root: Root, optic: Optic<State, Root>, stateOrUpdater: State | ((state: State) => State) | Updater<State>): Generator<OpticErr, Root>;
    get: Getter<State, Root>;
    set: Setter<State, Root>;
    ...
    find<Target extends ArrayItem<State>>(predicate: ((item: ArrayItem<State>, index: number) => boolean) | ((item: ArrayItem<State>, index: number) => item is Target)): Optic<Target, Root>;
    ...
    map<Target>(mapper: Selector<Target, ArrayItem<State>> | Optic<Target, ArrayItem<State>> | ((state: Optic<ArrayItem<State>, ArrayItem<State>>) => Optic<Target, ArrayItem<State>>)): Optic<Target[], Root>;
    getKey?: GetKey<State>;
    filter<Target extends ArrayItem<State>>(predicate: ((item: ArrayItem<State>, index: number) => boolean) | ((item: ArrayItem<State>, index: number) => item is Target)): Optic<Target[], Root>;
